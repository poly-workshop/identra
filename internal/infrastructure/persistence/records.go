...
func userRecordFromDomain(user *domain.UserModel) userRecord {
	if user == nil {
		return userRecord{}
	}
	return userRecord{
...
func userRecordToDomain(record userRecord) *domain.UserModel {
...
func copyUserRecordToDomain(record userRecord, user *domain.UserModel) {
	if user == nil {
		return
	}
...
func externalIdentityRecordFromDomain(identity *domain.ExternalIdentityModel) externalIdentityRecord {
	if identity == nil {
...
func externalIdentityRecordToDomain(record externalIdentityRecord) *domain.ExternalIdentityModel {
	return &domain.ExternalIdentityModel{
		ID:             record.ID,
...
func copyExternalIdentityRecordToDomain(record externalIdentityRecord, identity *domain.ExternalIdentityModel) {
	if identity == nil {
		return
	}

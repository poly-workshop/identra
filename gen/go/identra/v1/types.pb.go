...
const file_identra_v1_types_proto_rawDesc = "" +
	...
	"\bprovider\x18\x01 \x01(\tR\bprovider\x12(\n" +
	"\x10provider_user_id\x18\x02 \x01(\tR\x0eproviderUserId\"C\n" +
...
var file_identra_v1_types_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_identra_v1_types_proto_goTypes = []any{
	...
	(*GetCurrentUserLoginInfoRequest)(nil),   // 20: identra.v1.GetCurrentUserLoginInfoRequest
...
var file_identra_v1_types_proto_depIdxs = []int32{
	...
	19, // 8: identra.v1.GetCurrentUserLoginInfoResponse.oauth_connections:type_name -> identra.v1.OAuthConnection
